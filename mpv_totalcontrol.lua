...
function bindKeys()
	...
	mp.add_forced_key_binding("Shift+KP4",        'clearShaderPass1',         clearShaderPass1)
	mp.add_forced_key_binding("Shift+KP5",        'clearShaderPass2',         clearShaderPass2)
	mp.add_forced_key_binding("Shift+KP6",        'clearShaderPass3',         clearShaderPass3)
